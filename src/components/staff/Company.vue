...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>风险企业维护</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 卡片视图区 -->
    <el-card class="box-card" style="min-width:1000px">
        ...
        <el-col :span="6"
          ><div>
            <el-tooltip
              class="item"
              effect="dark"
              content="根据风险企业名称模糊查询"
              placement="top"
            >
              <el-input
                placeholder="请输入风险企业名称"
      ...
      >
        ...
        <el-table-column prop="phone" label="法人电话" >
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    //展示编辑物资信息的对话框
    showEditDialog(id, name, address, location, person, phone, type) {
      console.log(id, name, address, location, person, phone, type);
      this.editForm = { id, name, address, location, person, phone, type };
